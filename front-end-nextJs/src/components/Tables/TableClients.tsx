...
const TableClientes = ({ data }: ITableClientesProps) => {
  return (
        ...
        <div className="flex flex-col min-w-[1000px]"> {/* Definir largura mínima */}
          ...
          {data.map((d, key) => (
            ...
            >
              ...
              <div className="flex items-center justify-center p-2.5 xl:p-5">
                <p className="text-meta-3">{d.client.email}</p>
              </div>
              <div className="flex items-center justify-center p-2.5 xl:p-5">
                <p className="text-black dark:text-white">{d.client.status}</p>
              </div>
              <div className="flex items-center justify-center p-2.5 xl:p-5">
                <p className="text-black dark:text-white">{d.client.id_agente.name}</p>
              </div>
              <div className="flex items-center justify-center p-2.5 xl:p-5">
                <Link href={`/admin/clientes/${d.client._id}`}>
